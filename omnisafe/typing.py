...
OmnisafeSpace = Union[Box, Discrete, MultiDiscrete, MultiBinary]
...
ActorType = Literal['gaussian_learning', 'gaussian_sac', 'mlp', 'vae', 'perturbation', 'discrete', 'latent_discrete', 'latent_multi_discrete']
